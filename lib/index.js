(function() {
  ...
  module.exports.findPackageDependencies = function(opt) {
    var cwd, newFile, pathMap, pkg, stream;
    if (opt == null) {
      opt = {};
    }
    ...
    Object.keys(pkg.dependencies || []).forEach(function(dep) {
      var depDir, depFile, depPkg, newFile;
      ...
      if (fs.statSync(depDir).isDirectory()) {
        ...
        if (opt.paths && opt.paths[dep]) {
          if (typeof opt.paths[dep] === 'function') {
          ...
          if (typeof amdPathsCollection[dep] === 'function') {
