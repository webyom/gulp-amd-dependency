(function() {
  ...
  module.exports.findPackageDependencies = function(opt) {
    var cwd, newFile, originalPathMap, pathMap, pkg, stream;
    if (opt == null) {
      opt = {};
    }
    ...
    Object.keys(pkg.dependencies || []).forEach(function(dep) {
      ...
      if (fs.statSync(depDir).isDirectory()) {
        pushStream = function(dep, depFile) {
          var contents, depFileDir, newFile, sourceMap, sourceMapFile, sourceMapPath;
        ...
        if (converted) {
          if (typeof converted === 'function') {
            ...
            Object.keys(converted).filter(function(item) {
